...
public class TantrumInteractionLaserPointerPico : MonoBehaviour
{
    ...
    public bool CheckInput()
    {
        ...
        if(m_isRightController){
            return Pvr_UnitySDKAPI.Controller.UPvr_GetKeyDown(1, Pvr_UnitySDKAPI.Pvr_KeyCode.TRIGGER);
        }
    ...
    public bool CheckLongInput()
    {
        ...
        if(m_isRightController){
            return Pvr_UnitySDKAPI.Controller.UPvr_GetKey(1, Pvr_UnitySDKAPI.Pvr_KeyCode.TRIGGER);
        }
        return Pvr_UnitySDKAPI.Controller.UPvr_GetKey(0, Pvr_UnitySDKAPI.Pvr_KeyCode.TRIGGER);
    }
    ...
    public bool CheckOffInput()
    {
        ...
        if(m_isRightController){
            return Pvr_UnitySDKAPI.Controller.UPvr_GetKeyUp(1, Pvr_UnitySDKAPI.Pvr_KeyCode.TRIGGER);
        }
    ...
    private void SetBlip(Vector3 pos, float scale){
        m_blip.position = pos;
        var newScale = Mathf.Clamp(0.02f * scale, 0.1f, 0.5f);
